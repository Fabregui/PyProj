...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.TPanedwindow1 = ttk.Panedwindow(self.PNotebook2_t1_1
                , orient="horizontal")
        self.TPanedwindow1.place(relx=0.0, rely=0.0, relheight=1.029
                , relwidth=0.965)
        ...
        self.Scale1 =  tk.Scale(self.PNotebook2_t1_1, from_=0.0, to=100.0, resolution=1.0)
        self.Scale1.place(relx=0.947, rely=0.0, relheight=1.005, relwidth=0.05)
        ...
        self.Scale1.configure(length="586")
